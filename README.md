...
```javascript
beta = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-beta@v0.0.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/random-array-beta/actions/workflows/test.yml/badge.svg?branch=v0.0.1
[test-url]: https://github.com/stdlib-js/random-array-beta/actions/workflows/test.yml?query=branch:v0.0.1
