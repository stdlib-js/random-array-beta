...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-beta/tags). For example,

```javascript
beta = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-beta@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/random-array-beta/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-array-beta/actions/workflows/test.yml?query=branch:v0.2.2
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-beta.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-beta/main
...
[deno-url]: https://github.com/stdlib-js/random-array-beta/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-array-beta/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-array-beta/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-array-beta/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-array-beta/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-array-beta/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-array-beta/blob/main/branches.md
