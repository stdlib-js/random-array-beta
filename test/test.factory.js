...
tape( 'the function supports providing a seeded underlying PRNG (parameters)', function test( t ) {
	...
	arr1 = random1( 10, 2.0, 5.0 );
	arr2 = random2( 10, 2.0, 5.0 );
	t.deepEqual( arr1, arr2, 'returns expected value' );
